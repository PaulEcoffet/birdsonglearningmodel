...
\section{Day learning algorithm: Parameters optimization}\label{day-learning-algorithm}
...
algorithm. The bird picks a random song model to optimize, then picks a random
...
\section{Night learning algorithms: Sequence Optimization}\label{night-learning-algorithms}
...
which no longer correspond to their target.

Evolutionary algorithms are amongst the simplest algorithms to optimize a
sequence. We implemented different evolutionary algorithms to test
